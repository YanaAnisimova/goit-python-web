...
insert into groups (group_name, group_year)
values ('G-1', 2020), 
('G-2', 2020), 
('G-3', 2020)
returning *;
...
insert into student (full_name, id_group)
values ('Adam Chase', 1), 
('Belinda Sanders', 1),
('Elaina Bennett', 1), 
('Floss Perez', 1),
...
-- студент сам выберает от 2х до 5ти предметов.
...
insert into mark (mark, id_student, id_subject, id_teacher, mark_date)
...
-- 3. Cредний балл в группе по одному предмету:
...
-- 5. Какие курсы читает преподавател:
